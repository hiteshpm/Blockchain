...
echo "Instantiating chaincode on peer1.org3..."
instantiateChaincode 1 3

echo "Instantiating chaincode on peer1.org4..."
#instantiateChaincode 1 4

echo "Instantiating chaincode on peer1.org5..."
#instantiateChaincode 1 5
